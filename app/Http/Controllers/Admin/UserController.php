...
class UserController extends Controller
{
    ...
    public function check()
    {
        ...
        $count_datas = array();
        for ($i = 11; $i >= 0; $i--) {
            $first_month_day = Carbon::now()->day(1)->subMonths($i)->startOfMonth()->toDateString()." 00:00:00";
            $last_month_day = Carbon::now()->day(1)->subMonths($i)->endOfMonth()->toDateString()." 23:59:59";
