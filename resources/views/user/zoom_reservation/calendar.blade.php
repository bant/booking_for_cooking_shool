        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <form action="{{route('user.message.send_cancel_message',$reservation->id)}}" method="POST" style="display: inline;" onsubmit="return confirm('予約の取り消し依頼を送信しますか?');">
                            @csrf
        ...
        <table class="table table-sm table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <form action="{{route('user.message.send_cancel_message',$wait_list_reservation->id)}}" method="POST" style="display: inline;" onsubmit="return confirm('キャンセル待ちの取り消し依頼をしますか?');">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-danger"><i class="fas fa-paper-plane"></i>　取り消しメッセージ</button>
                        </form>
                    </td>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var calendar = new Calendar(calendarEl, {
            ...
            eventRender: function(info) {
                $(info.el).tooltip({
                    title: '<i class="fa fa-users"></i>&nbsp;<b>教室情報</b><br/>' +
