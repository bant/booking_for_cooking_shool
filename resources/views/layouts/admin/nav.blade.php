<div id="nav">
    ...
    <div class="menu"><a href="#" title="生徒・先生の管理">生徒・先生の管理</a>
        <div class="submenu">
            <a class="subitem" href="{{ route('admin.user.search') }}" title="生徒の管理">生徒の管理</a>
            <a class="subitem" href="{{ route('admin.staff.search') }}" title="先生の管理">先生の管理</a>
        </div><!-- .submenu -->
    </div><!-- .menu -->
