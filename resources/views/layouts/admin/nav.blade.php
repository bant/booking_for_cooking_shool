<div id="nav">
    <div class="menu"><div class="menu"><a class="slite" href="#">ポイント管理</a>
        <div class="submenu">
    ...
    <div class="menu"><div class="menu"><a class="slite" href="#">入金確認通知</a>
        <div class="submenu">
    ...
    <div class="menu"><div class="menu"><a class="slite" href="#">生徒の管理</a>
        <div class="submenu">
