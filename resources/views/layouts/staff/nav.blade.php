<div id="nav">
    <div class="menu"><div class="menu"><a class="slite" href="#">基本設定</a>
        <div class="submenu">
    ...
    <div class="menu"><div class="menu"><a class="slite" href="#">予約・スケジュール管理</a>
        <div class="submenu">
    ...
    <div class="menu"><div class="menu"><a class="slite" href="#">連絡・メッセージ</a>
        <div class="submenu">
