...
<div id="content">
    ...
    <form action="{{ route('admin.message.send_to_staff_message') }}" method="POST">
        ...
        <input type="hidden" name="staff_id" value="{{$reservation->schedule->staff->id}}">
        <input type="hidden" name="staff_name" value="{{$reservation->schedule->staff->name}}">
