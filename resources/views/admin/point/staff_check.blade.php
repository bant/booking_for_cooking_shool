...
<div id="content">
  ...
  <section>
    ...
    <h2>{{date('Y年m月', strtotime($now_first_month_day)) }}のポイント状況
      ...
      <a class="float-right btn btn-sm btn-primary" href="{{ route('admin.point.staff_check_show', ['id' => $staff->id, 'date' => $previous_first_month_day])}}">
        << 前月</a> </h2> <h3>{{$staff->room->name}}のポイント状況</h3>
          ...
          <table class="table table-sm table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center text-white bg-success"><strong>ポイント払い</strong></td>
                @else
                <td class="text-center text-white bg-danger"><strong>ポイント以外</strong></td>
                @endif
